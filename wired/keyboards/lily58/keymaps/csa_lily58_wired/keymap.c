 ...
 */
    [_QWERTZ] = LAYOUT(
            ...
            KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, MO(1),      MO(1), KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
 ...
 */
    [_MEDIA] = LAYOUT(
            ...
            KC_LCTL, KC_NO, KC_NO, KC_KB_VOLUME_DOWN, KC_NO, KC_NO, TG(3),             TG(3), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RSFT,
                                            KC_LGUI, KC_LALT, KC_DEL, KC_SPC,      KC_ENT, KC_BSPC, KC_RALT, MO(2)),
